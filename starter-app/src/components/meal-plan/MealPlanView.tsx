    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4">
        <button
          onClick={undo}
          disabled={!canUndo}
          className="px-6 py-3 bg-white/10 hover:bg-white/20 disabled:opacity-50 text-white rounded-lg transition-all duration-200 font-medium hover:scale-105"
        >
          ↶ Undo
        </button>
        <button
          onClick={resetToOriginal}
          className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all duration-200 font-medium hover:scale-105"
        >
          Reset to Original
        </button>
      </div>
