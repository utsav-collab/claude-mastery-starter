---
name: qa-agent
description: Use this agent to find bugs before users do. Tests happy paths, edge cases, accessibility, and responsive design. Creates bug reports and pre-ship checklists.
model: sonnet
---
