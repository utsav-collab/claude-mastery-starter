---
name: debug-fix
description: Use this agent when something is broken. Paste your error message and it will explain what went wrong in plain English, find the root cause, and fix it properly.
model: sonnet
---
